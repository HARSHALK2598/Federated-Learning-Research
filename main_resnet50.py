...
def lr_lambda(epoch):
    if epoch < 20:
        return 1.0  # Keep the learning rate as 0.1
    elif 20 <= epoch < 30:
        return 0.1  # Reduce the learning rate to 0.01
    elif 30 <= epoch < 40:
        return 0.01
    else:
        return 0.001  # Further reduce the learning rate to 0.001
...
def train_and_evaluate():
    ...
    model_resnet50 = get_resnet50(num_classes=10, pretrained=True)
